 ...
 */
async function aggregateHealthRecords(req, res, next) {
    try {
        ...
        const dailyRecords = logs.map((log) => {
            ...
            return {
                ...
                activity: log.activity ? { durationMinutes: log.activity.durationMinutes || 0, steps: log.activity.steps || 0, caloriesBurned: log.activity.caloriesBurned || 0 } : null,
...
module.exports = { aggregateHealthRecords };
